# CDISC CORE validation -- submission-pilot3 (SDTM)
...
- **CORE-000733** (33): TSPARMCD = RANDQT record is not present
- **CORE-000741** (33): The set  ('INTMODEL’, 'INTTYPE','PCLASS') is not in the list of TSPARAMCD with TSVAL populated.
- **CORE-000294** (1): TSVAL is not in ISO 8601 format
- **CORE-000334** (1): At least one expected variable is missing from dataset
- **CORE-000730** (1): TSVAL does not conform to ISO 8601
- **CORE-000731** (1): TSVAL is not NULL and does not conform to ISO 8601 time period
- **CORE-000740** (1): A required value of TSPARMCD is not found
- **CORE-000929** (1): rule evaluation error - evaluation dataset failed to build
- **CORE-001081** (1): rule evaluation error - evaluation dataset failed to build
...
| Record | Variables | Values | Rule | Message |
|--------|-----------|--------|------|---------|
| 2 | TSPARMCD;TSVAL | AGEMAX;No maximum | CORE-000294 | TSVAL is not in ISO 8601 format |
|  | $dataset_variables;$expected_v | ['STUDYID', 'DOMAIN' | CORE-000334 | At least one expected variable is missing from dataset |
| 3 | TSVAL;TSPARMCD | 50 years;AGEMIN | CORE-000730 | TSVAL does not conform to ISO 8601 |
| 16 | TSVAL;TSPARMCD | 26 weeks;LENGTH | CORE-000731 | TSVAL is not NULL and does not conform to ISO 8601 time period |
| 1 | TSPARMCD;$trt_count;$rand_coun | ADDON;1;Not in datas | CORE-000733 | TSPARMCD = RANDQT record is not present |
