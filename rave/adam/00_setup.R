# Local-data setup for the admiral ADaM derivations (RAVE — rituximab vs
# cyclophosphamide in ANCA-associated vasculitis). Sourced at the top of every
# ad_*.R. Defines SDTM_DIR / ADAM_DIR + read_sdtm/read_adam/save_adam so programs
# run against THIS environment's generated SDTM (../sdtm/sdtm-derived/xpt/).
# Mirrors cdiscpilot1. Run from adam/. Env vars: ADAM_SDTM_DIR, ADAM_OUT_DIR.
...
.adam_var_labels <- c(
  ...
  DTHFL = "Subject Death Flag", DTHDT = "Date of Death",
