#!/usr/bin/env Rscript
#' =============================================================================
#' ARA06 end-to-end pipeline  (Anti-TNF Agents in Rheumatoid Arthritis, NCT00837434)
#' =============================================================================
...
#' config (N=63, seed=2009); change n_patients/seed via a GenConfig in
