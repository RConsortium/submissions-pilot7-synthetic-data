...
# `read_adam("adsl")` (etc.); legacy `cad<name>` ids resolve via CAD_TO_ADAM.
#
# ADaM datasets we generate: adsl adae advs adlb adrs. Tasks needing analysis
# data we do NOT derive are reported BLOCKED, not faked.
