# Local-data setup for the admiral ADaM derivations (ARA06).
...
# environment's generated SDTM (../sdtm/sdtm-derived/xpt/). Mirrors the
# cdiscpilot1 adam setup.
#
# Run from adam/ (see GUIDE.md). Override via env vars:
