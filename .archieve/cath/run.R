#!/usr/bin/env Rscript
#' =============================================================================
#' CATH end-to-end pipeline  (Vitamin D3 vs Placebo, skin AMP study, NCT00789880)
#' =============================================================================
...
#' config (N=82, seed=88); change seed/scale via a GenConfig in
